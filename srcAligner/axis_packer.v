...
# (
 ...
 (
    ...
    input  wire [DATA_WIDTH_SRC-1: 0]     S_AXI_TDATA,
//    input  wire [DATA_WIDTH/8-1:0]   S_AXI_TKEEP,  // <= tkeep added
    ...
    output  wire [PACK_SIZE*(DATA_WIDTH_SRC/DATA_WIDTH_ALG)-1: 0] M_AXI_TDATA,
//    output  reg [DATA_WIDTH/8-1:0]   M_AXI_TKEEP,  // <= tkeep added
    ...
    generate
        for (i = 0; i < (DATA_WIDTH_SRC/DATA_WIDTH_ALG); i = (i + 1)) begin : pack_loop
            assign M_AXI_TDATA[i*PACK_SIZE +: PACK_SIZE] = S_AXI_TDATA[i*DATA_WIDTH_ALG +: PACK_SIZE];
        end
    endgenerate
