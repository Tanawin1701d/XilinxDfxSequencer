...
(
    parameter integer DATA_WIDTH_INPUT        = 32,
    parameter integer DATA_WIDTH_OUTPUT       = 32,
    parameter integer DATA_EXACT_CPY          = 32,
    parameter integer STORAGE_IDX_WIDTH = 10     //// 4 Kb
)
(
    // AXIS Slave Interface   store in terface
    input  wire [DATA_WIDTH_INPUT-1:0]     S_AXI_TDATA,
//    input  wire [DATA_WIDTH/8-1:0]   S_AXI_TKEEP,  // <= tkeep added
    ...
    output  reg [DATA_WIDTH_OUTPUT-1:0]     M_AXI_TDATA,
...
//        M_AXI_TKEEP  <= 0; // Reset tkeep
        ...
        M_AXI_TLAST  <= 1'b0; // Reset last signal
           ...
           M_AXI_TDATA                       = 0;  
           M_AXI_TDATA[DATA_EXACT_CPY-1: 0]  =  S_AXI_TDATA;
